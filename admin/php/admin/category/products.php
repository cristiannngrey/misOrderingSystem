      ...
      $status = $row['status'];
          ...
          if($status==='available'){
                  ...
                  echo "<div class='item animated fadeInDowns' id='$category'>
                            ...
                            <center>
                                <button class='update' id='update-prod' alt='$id'>Update</button>
                                ...
                                <form id='deleteprod' action='../php/admin/crud/delete.php' method='post' style='display:inline !important;'>
                                    <input type='hidden' name='id' value='$id'>
                  ...
                  echo "<div class='item animated fadeInDowns' id='$category'>
                            ...
                            <center>
                                ...
                                <form id='able' action='../php/admin/crud/availability.php' method='post' style='display:inline !important;'>
                                    <input type='hidden' name='status' value='$status'>
                                    <input type='hidden' name='id' value='$id'>
                                    <button class='not' style='background-color:#ea6052;'>Able</button>
                                </form>
                                <form id='deleteprod' action='../php/admin/crud/delete.php' method='post' style='display:inline !important;'>
                                    <input type='hidden' name='id' value='$id'>
                                    <button class='delete'>Delete</button>
